...
import 'package:admin_page/views/screens/manage_products_screen.dart';
import 'package:admin_page/views/widgets/product_item.dart';
...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  void deleteProduct(Product product) async {
    final response = await showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          content: Text("Siz ${product.name}'ni o'chirmoqchimisiz?"),
          actions: [
            TextButton(
              onPressed: () {
